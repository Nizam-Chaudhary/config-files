        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", cssLanguageService.doComplete2(embedded, position, stylesheet, documentContext, _settings === null || _settings === void 0 || (_settings$css = _settings.css) === null || _settings$css === void 0 ? void 0 : _settings$css.completion) || languageModes_1.CompletionList.create());
            case 4:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              embedded = embeddedCSSDocuments.get(document);
              return _context3.abrupt("return", cssLanguageService.doHover(embedded, position, cssStylesheets.get(embedded), settings === null || settings === void 0 || (_settings$css2 = settings.css) === null || _settings$css2 === void 0 ? void 0 : _settings$css2.hover));
            case 3:
            case "end":
