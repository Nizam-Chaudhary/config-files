...
function registerDiagnosticsPushSupport(documents, connection, runtime, validate) {
  ...
  function triggerValidation(textDocument) {
    ...
    var request = pendingValidationRequests[textDocument.uri] = runtime.timer.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var diagnostics;
...
function registerDiagnosticsPullSupport(documents, connection, runtime, validate) {
  ...
  var registration = connection.languages.diagnostics.on( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params, token) {
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", (0, runner_1.runSafe)(runtime, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              var document;
